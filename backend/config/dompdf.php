...
return [
    ...
    */
    ...
    'options' => [
         ...
         * Note: This directory must exist and be writable by the webserver process.
         */
        'font_cache' => base_path('storage/cache'),
        ...
        'fonts' => [
            'dax-light' => [
                'normal' => 'DAX-Light.ttf',
                'bold' => 'DAX-Medium.ttf',
                'italic' => 'DAX-Light.ttf',
                'bold_italic' => 'DAX-Medium.ttf'
            ],
            'dax-medium' => [
                'normal' => 'DAX-Medium.ttf',
                'bold' => 'DAX-Medium.ttf',
                'italic' => 'DAX-Medium.ttf',
                'bold_italic' => 'DAX-Medium.ttf'
            ],
        ],
    ],
