...
<body>
    @foreach($restitutions as $restitutionIndex => $restitution)
        @if($restitutionIndex > 0)
        ...
        <div class="receipt-block">
            ...
            @if($restitution->caution_ref ?? false)
            <div class="info-row">
                <span style="display: inline-block; width: 45%;">
                    <span class="info-label bold-label">Réf. Caution :</span>
                    <span class="info-value grey-value">{{ $restitution->caution_ref }}</span>
                </span>
            </div>
            @endif
